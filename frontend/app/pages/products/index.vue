      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        >
          <NuxtLink
            ...
            class="relative w-full h-64 bg-gray-50 overflow-hidden block"
          >
            <img
            ...
            <div
              v-else
              class="w-full h-full flex items-center justify-center bg-gray-100 text-gray-400 group-hover:bg-gray-200 transition-colors"
            >
              <svg
          ...
          <div class="p-6 flex flex-col flex-grow">
            ...
            <NuxtLink :to="`/products/${produit.slug}`" class="block mb-2">
              <h3
                class="text-lg font-bold text-gray-900 group-hover:text-black transition-colors line-clamp-1"
              >
                {{ produit.name }}
              </h3>
            </NuxtLink>
            ...
            <div
              class="flex justify-between items-center mt-auto border-t border-gray-50 pt-4"
            >
...
const {
  ...
  pending,
  error,
} = await useLazyFetch(`${config.public.apiBase}/products`);

const categoryQuery = route.query.categorie || null;
